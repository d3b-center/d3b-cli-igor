...
def list_objects(bucket_name,s3_client,next_marker):
    if (next_marker == ""):
        ...
        objects = s3_client.list_object_versions(Bucket=bucket_name,KeyMarker=next_marker)
    return objects
...
def get_object_versions(bucket_name,s3_client,next_marker,all_versioned_objects):
    ...
    while ("NextKeyMarker" in objects and objects["NextKeyMarker"] != ""):
        ...
        printProgressBar(str(len(all_versioned_objects)),"Number of objects found in the bucket ")
