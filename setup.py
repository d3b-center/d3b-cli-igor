...
setuptools.setup(
    ...
    packages=[
        ...
        "d3b_cli_igor.deploy_ops.config",
        "d3b_cli_igor.deploy_ops.templates",
        "d3b_cli_igor.log_ops",
        "d3b_cli_igor.utils",
        "d3b_cli_igor.utils.config",
        "d3b_cli_igor.utils.scripts",
        "d3b_cli_igor.utils.templates",
    ],
    package_data={
        'd3b_cli_igor.deploy_ops': ['d3b_cli_igor/deploy_ops/templates/*.tmpl'],
        'd3b_cli_igor.deploy_ops': ['d3b_cli_igor/deploy_ops/config/*.json'],
        'd3b_cli_igor.utils': ['d3b_cli_igor/utils/templates'],
        'd3b_cli_igor.utils': ['d3b_cli_igor/utils/config/*.yaml'],
        'd3b_cli_igor': ['d3b_cli_igor/config/*.json'],
    },
